...
def right_cw(rotated_back, back, rotated_right, down, rotated_up, right, rotated_front, up, rotated_down, front):
	...
	# down
	rotated_down[0][2] = back[2][0]
	rotated_down[1][2] = back[1][0]
	rotated_down[2][2] = back[0][0]

	return rotated_back, rotated_right, rotated_up, rotated_front, rotated_down

def up_cw(rotated_back, back, rotated_right, left, rotated_up, right, rotated_front, up, rotated_left, front):
	# up
	...
	#left
	rotated_left[0][0] = front[0][0]
	rotated_left[0][1] = front[0][1]
	rotated_left[0][2] = front[0][2]

	# back
	rotated_back[0][2] = left[0][2]
	rotated_back[0][1] = left[0][1]
	rotated_back[0][0] = left[0][0]

	# right
	rotated_right[0][2] = back[0][2]
	rotated_right[0][1] = back[0][1]
	rotated_right[0][0] = back[0][0]

	# front
	rotated_front[0][0] = right[0][0]
	rotated_front[0][1] = right[0][1]
	rotated_front[0][2] = right[0][2]

	return rotated_back, rotated_right, rotated_up, rotated_front, rotated_left


def down_cw(rotated_back, back, rotated_right, left, rotated_down, right, rotated_front, down, rotated_left, front):
	# down
	...
	#left
	rotated_left[2][2] = back[2][2]
	rotated_left[2][1] = back[2][1]
	rotated_left[2][0] = back[2][0]

	# front
	rotated_front[2][0] = left[2][0]
	rotated_front[2][1] = left[2][1]
	rotated_front[2][2] = left[2][2]

	# right
	rotated_right[2][2] = front[2][2]
	rotated_right[2][1] = front[2][1]
	rotated_right[2][0] = front[2][0]

	# back
	rotated_back[2][2] = right[2][2]
	rotated_back[2][1] = right[2][1]
	rotated_back[2][0] = right[2][0]
